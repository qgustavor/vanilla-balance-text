...
r):m+d}a.style.whiteSpace=f;a.style.cssFloat=h;a.style.display=v;a.style.position=x;a.style.lineHeight=C}};v.balanceText=F;v.balanceText.update=x;v.balanceText.removeTags=E;"loading"!=document.readyState?x():document.addEventListener("DOMContentLoaded",x);smartresize(window,x)})("undefined"!==typeof module&&module.exports?module.exports:self||{});